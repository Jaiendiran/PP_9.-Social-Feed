      ...
      <div className="landing-container">
        <div className="landing-inner">
          <header className="landing-header">
            <div className="brand">Blogyst</div>
            <button className="signup-btn" onClick={() => navigate('/signup')}>Sign up</button>
          </header>

          <section className={`hero hero-bg`} role="region" aria-label="Hero">
            <div className="hero-content">
              <h1>Where Curiosity Meets Content</h1>
              <p>Explore insightful articles on technology, design, and modern lifestyle.</p>
              <button className="read-btn" onClick={() => navigate('/')}>Read Our Latest Post</button>
            </div>
          </section>
            ...
            <div className="featured-grid">
              <article className="card">
                ...
                <div>
                  ...
                  <p className="meta">John Doe - Oct 26, 2023</p>
                </div>
              </article>
              ...
              <article className="card">
                ...
                <div>
                  ...
                  <p className="meta">Jane Smith - Oct 24, 2023</p>
                </div>
              </article>
              ...
              <article className="card">
                ...
                <div>
                  ...
                  <p className="meta">Emily White - Oct 22, 2023</p>
                </div>
              </article>
            </div>
          </section>
          ...
          <section className="topics">
            ...
            <div className="topics-list">
              {['Technology','Design','Lifestyle','Productivity','Marketing'].map(t => (
                <button key={t} className="topic-btn">{t}</button>
              ))}
            </div>
          </section>
          ...
          <section className="newsletter">
            <div className="box">
              ...
              <button className="subscribe" onClick={() => navigate('/signup')}>Sign up</button>
            </div>
          </section>
